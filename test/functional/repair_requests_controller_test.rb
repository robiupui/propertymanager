...
class RepairRequestsControllerTest < ActionController::TestCase
  ...
  test "should create repair_request" do
    assert_difference('RepairRequest.count') do
      post :create, repair_request: { close_date: @repair_request.close_date, open_date: @repair_request.open_date, request_details: @repair_request.request_details, request_response: @repair_request.request_response }
    end
  ...
  test "should update repair_request" do
    put :update, id: @repair_request, repair_request: { close_date: @repair_request.close_date, open_date: @repair_request.open_date, request_details: @repair_request.request_details, request_response: @repair_request.request_response }
    assert_redirected_to repair_request_path(assigns(:repair_request))
  end
